...
import resume from "../assets/Rafael_Anguiano_Resume.pdf"
    ...
    const links = [
        {
            ...
            href: 'https://www.linkedin.com/in/rafael-anguiano/',
            style: 'rounded-tr-md',
        },
        {
            id:2,
            ...
            href: 'https://github.com/Rafael-Anguiano',
        },
        {
            id:3,
            child: (
            ...
            href: 'mailto:rj.anguiano.23@gmail.com',
        },
        {
            id:4,
            child: (
